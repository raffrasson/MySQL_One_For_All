...
INSERT INTO SpotifyClone.users(user_name, user_age, plan_id, plan_date) VALUES
...
INSERT INTO SpotifyClone.songs (song_name, album_id, song_length)
VALUES
	("Soul For Us", 1, 200),
...
CREATE TABLE SpotifyClone.followed_artists(
	...
	artist_id INT NOT NULL,
  CONSTRAINT following_id PRIMARY KEY (user_id, artist_id),
	FOREIGN KEY (user_id) REFERENCES SpotifyClone.users(user_id),
	FOREIGN KEY (artist_id) REFERENCES SpotifyClone.artists(artist_id)
) ENGINE = InnoDB;
  
INSERT INTO SpotifyClone.followed_artists VALUES
(1, 1),
(1, 4),
(1, 3),
(2, 1),
...
CREATE TABLE SpotifyClone.user_history(
	CONSTRAINT history_id PRIMARY KEY (user_id, song_id),
	user_id INT NOT NULL,
...
INSERT INTO SpotifyClone.user_history(user_id, song_id, played_on) VALUES
